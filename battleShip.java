...
public class battleShip extends JFrame implements ActionListener
{
    ...
    public battleShip( )
    {
        ...
        board.setGridColor(Color.CYAN);
         ...
         JLabel numMoves = new JLabel("Number of Moves: " + numOfMoves);
         numOfMoves++;
         panel1.add(numMoves);
	...
	public void save(){	   
		  ...
		  String x = JOptionPane.showInputDialog(null,"Enter the file name. Do not enter .txt");
		  x = "src/" + x + ".txt";

		  File savedGame = new File(x);
	   
		  try {
			  outPutStream = new PrintWriter(savedGame);
